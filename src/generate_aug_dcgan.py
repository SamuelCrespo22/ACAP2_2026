...
def generate_augmented_dcgan():
    ...
    netG.load_state_dict(torch.load("results_gen/dcgan2e4_ev2_p20_padding/best_dcgan_g.pth", map_location=device))
    netG.eval()
    ...
    with torch.no_grad():
        for class_idx, class_name in enumerate(classes):
            ...
            print(f"DCGAN generating {to_generate} images for class: {class_name} (Current count: {class_count})...")
    ...
    print(f"DCGAN Dataset concluded: {output_csv}")
